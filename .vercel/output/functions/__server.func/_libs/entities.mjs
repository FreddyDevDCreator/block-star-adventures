...
function requireDecodeDataHtml() {
  ...
  decodeDataHtml.htmlDecodeTree = void 0;
  decodeDataHtml.htmlDecodeTree = new Uint16Array(
    // prettier-ignore
...
function requireDecodeDataXml() {
  ...
  decodeDataXml.xmlDecodeTree = void 0;
  decodeDataXml.xmlDecodeTree = new Uint16Array(
    // prettier-ignore
...
function require_escape() {
  ...
  (function(exports$1) {
    ...
    exports$1.escapeAttribute = /* @__PURE__ */ getEscaper(/["&\u00A0]/g, /* @__PURE__ */ new Map([
      [34, "&quot;"],
      [38, "&amp;"],
      [160, "&nbsp;"]
    ]));
