...
import { r as requireCjs } from "./asamuzakjp__css-color.mjs";
var CSSStyleDeclaration = {};
var allWebkitProperties;
var hasRequiredAllWebkitProperties;
function requireAllWebkitProperties() {
  if (hasRequiredAllWebkitProperties) return allWebkitProperties;
  hasRequiredAllWebkitProperties = 1;
  allWebkitProperties = [
  ...
  return allWebkitProperties;
}
var allExtraProperties;
var hasRequiredAllExtraProperties;
function requireAllExtraProperties() {
  if (hasRequiredAllExtraProperties) return allExtraProperties;
  hasRequiredAllExtraProperties = 1;
  const allWebkitProperties2 = requireAllWebkitProperties();
  allExtraProperties = /* @__PURE__ */ new Set([
    ...
    "unicode-range",
    "vector-effect",
    ...allWebkitProperties2
  ]);
  return allExtraProperties;
}
var allProperties;
var hasRequiredAllProperties;
function requireAllProperties() {
  if (hasRequiredAllProperties) return allProperties;
  hasRequiredAllProperties = 1;
  allProperties = /* @__PURE__ */ new Set([
    "-webkit-line-clamp",
    "accent-color",
    "align-content",
    "align-items",
...
var hasRequiredImplementedProperties;
function requireImplementedProperties() {
  if (hasRequiredImplementedProperties) return implementedProperties;
  hasRequiredImplementedProperties = 1;
  implementedProperties = /* @__PURE__ */ new Set([
    "background",
    "background-attachment",
    "background-color",
    "background-image",
...
function requireStrings() {
  ...
  strings.asciiWhitespaceRe = asciiWhitespaceRe;
  strings.asciiLowercase = (s) => {
    const len = s.length;
  ...
  strings.asciiUppercase = (s) => {
    const len = s.length;
    const out = new Array(len);
    for (let i = 0; i < len; i++) {
      const code = s.charCodeAt(i);
      out[i] = code >= 97 && code <= 122 ? String.fromCharCode(code & -33) : s[i];
    }
    return out.join("");
  };
  strings.stripNewlines = (s) => {
    return s.replace(/[\n\r]+/g, "");
  };
  strings.stripLeadingAndTrailingASCIIWhitespace = (s) => {
    return s.replace(/^[ \t\n\f\r]+/, "").replace(/[ \t\n\f\r]+$/, "");
  };
  strings.stripAndCollapseASCIIWhitespace = (s) => {
    return s.replace(/[ \t\n\f\r]+/g, " ").replace(/^[ \t\n\f\r]+/, "").replace(/[ \t\n\f\r]+$/, "");
  };
  strings.isValidSimpleColor = (s) => {
    return /^#[a-fA-F\d]{6}$/.test(s);
  };
  strings.asciiCaseInsensitiveMatch = (a, b) => {
  ...
  const parseInteger = strings.parseInteger = (input) => {
  ...
  strings.parseNonNegativeInteger = (input) => {
  ...
  strings.isValidFloatingPointNumber = (str) => floatingPointNumRe.test(str);
  strings.parseFloatingPointNumber = (str) => {
  ...
  strings.splitOnASCIIWhitespace = (str) => {
    let position = 0;
    const tokens = [];
...
function requireParsers() {
  ...
  (function(exports$1) {
    const { resolve: resolveColor, utils } = requireCjs();
    const { asciiLowercase } = requireStrings();
    ...
    const stringRegEx = /^("[^"]*"|'[^']*')$/;
    const varRegEx = /^var\(/;
    const varContainedRegEx = new RegExp("(?<=[*/\\s(])var\\(");
    ...
    const getNumericType = function getNumericType2(val) {
    ...
    exports$1.prepareValue = function prepareValue(value, globalObject = globalThis) {
      if (value === null) {
        return "";
      }
    ...
    exports$1.hasVarFunc = function hasVarFunc(val) {
      return varRegEx.test(val) || varContainedRegEx.test(val);
    };
    exports$1.parseNumber = function parseNumber(val, restrictToPositive = false) {
      if (val === "") {
        return "";
      }
    ...
    exports$1.parseLength = function parseLength(val, restrictToPositive = false) {
      if (val === "") {
        return "";
      }
      const type = getNumericType(val);
    ...
    exports$1.parsePercent = function parsePercent(val, restrictToPositive = false) {
      if (val === "") {
        return "";
      }
      const type = getNumericType(val);
    ...
    exports$1.parseMeasurement = function parseMeasurement(val, restrictToPositive = false) {
      if (val === "") {
        return "";
      }
      const type = getNumericType(val);
    ...
    exports$1.parseAngle = function parseAngle(val, normalizeDeg = false) {
      if (val === "") {
        return "";
      }
      const type = getNumericType(val);
    ...
    exports$1.parseUrl = function parseUrl(val) {
      if (val === "") {
        return val;
      }
    ...
    exports$1.parseString = function parseString(val) {
      if (val === "") {
        return "";
      }
    ...
    exports$1.parseKeyword = function parseKeyword(val, validKeywords = []) {
      if (val === "") {
        return "";
      }
      if (varRegEx.test(val)) {
    ...
    exports$1.parseColor = function parseColor(val) {
      if (val === "") {
        return "";
      }
      if (varRegEx.test(val)) {
      ...
      return exports$1.parseKeyword(val);
    };
    exports$1.parseImage = function parseImage(val) {
      if (val === "") {
        return "";
      }
      if (varRegEx.test(val)) {
      ...
      if (keywordRegEx.test(val)) {
        return exports$1.parseKeyword(val, ["none"]);
      }
      ...
      for (let i = 0; i < values.length; i++) {
        ...
        const imageUrl = exports$1.parseUrl(image);
        if (imageUrl) {
          values[i] = imageUrl;
        } else {
          isImage = false;
    ...
    exports$1.parseFunction = function parseFunction(val) {
      if (val === "") {
        return {
          name: null,
          value: ""
    ...
    exports$1.parseShorthand = function parseShorthand(val, shorthandFor, preserve = false) {
      const obj = {};
      if (val === "" || exports$1.hasVarFunc(val)) {
        for (const [property] of shorthandFor) {
          obj[property] = "";
        }
        return obj;
      }
      const key = exports$1.parseKeyword(val);
      if (key) {
        if (key === "inherit") {
          return obj;
        }
    ...
    exports$1.isValidColor = function isValidColor(val) {
      if (SYS_COLOR.includes(asciiLowercase(val))) {
        return true;
      }
      return isColor(val);
    };
    exports$1.splitValue = splitValue;
  })(parsers);
  return parsers;
}
var properties;
...
function requireProperties() {
  ...
  var external_dependency_parsers_0 = requireParsers();
  var external_dependency_strings_1 = requireStrings();
  ...
  backgroundPosition_export_parse = function parse(v) {
    ...
    if (parts.length === 1) {
      ...
      const validKeywords = /* @__PURE__ */ new Set([...validKeywordsX, ...validKeywordsY]);
  ...
  const background_local_var_shorthandFor = /* @__PURE__ */ new Map([["background-image", {
  ...
  const border_local_var_shorthandFor = /* @__PURE__ */ new Map([["border-width", {
  ...
  const borderBottom_local_var_shorthandFor = /* @__PURE__ */ new Map([["border-bottom-width", {
  ...
  const borderLeft_local_var_shorthandFor = /* @__PURE__ */ new Map([["border-left-width", {
    parse: borderTopWidth_export_parse,
    isValid: borderTopWidth_export_isValid,
    definition: borderTopWidth_export_definition
  }], ["border-left-style", {
  ...
  const borderRight_local_var_shorthandFor = /* @__PURE__ */ new Map([["border-right-width", {
    parse: borderTopWidth_export_parse,
    isValid: borderTopWidth_export_isValid,
    definition: borderTopWidth_export_definition
  }], ["border-right-style", {
  ...
  const borderTop_local_var_shorthandFor = /* @__PURE__ */ new Map([["border-top-width", {
    parse: borderTopWidth_export_parse,
    isValid: borderTopWidth_export_isValid,
    definition: borderTopWidth_export_definition
  }], ["border-top-style", {
  ...
  var flex_export_parse, flex_export_definition;
  const flex_local_var_shorthandFor = /* @__PURE__ */ new Map([["flex-grow", {
  ...
  const font_local_var_shorthandFor = /* @__PURE__ */ new Map([["font-style", {
  ...
  font_export_parse = function parse(v) {
    ...
    if (fontBlockB) {
      ...
      const properties2 = ["font-style", "font-variant", "font-weight", "font-size"];
      for (const part of parts) {
        if (part === "normal") {
          continue;
        } else {
      ...
      const revFontFamily = [];
      const properties2 = ["font-style", "font-variant", "font-weight", "line-height"];
...
function requireCamelize() {
  ...
  const { asciiLowercase } = requireStrings();
  camelize.dashedToCamelCase = function(dashed) {
  ...
  camelize.camelCaseToDashed = function(camelCase) {
    if (camelCase.startsWith("--")) {
      return camelCase;
    }
    const dashed = asciiLowercase(camelCase.replace(new RegExp("(?<=[a-z])[A-Z]", "g"), "-$&"));
...
var hasRequiredPropertyDescriptors;
function requirePropertyDescriptors() {
  if (hasRequiredPropertyDescriptors) return propertyDescriptors;
  hasRequiredPropertyDescriptors = 1;
  const prepareValue = requireParsers().prepareValue;
  propertyDescriptors.getPropertyDescriptor = function getPropertyDescriptor(property) {
    return {
      set(v) {
...
function requireCSSStyleDeclaration() {
  ...
  const CSSOM = requireLib();
  const allExtraProperties2 = requireAllExtraProperties();
  const allProperties2 = requireAllProperties();
  const implementedProperties2 = requireImplementedProperties();
  const generatedProperties = requireProperties();
  const { hasVarFunc, parseKeyword, parseShorthand, prepareValue, splitValue } = requireParsers();
  const { dashedToCamelCase } = requireCamelize();
  const { getPropertyDescriptor } = requirePropertyDescriptors();
  const { asciiLowercase } = requireStrings();
  let CSSStyleDeclaration$1 = class CSSStyleDeclaration {
    /**
    ...
    get cssText() {
      ...
      for (let i = 0; i < this._length; i++) {
        ...
        if (priority === "important") {
          properties2.push(`${property}: ${value} !${priority};`);
        } else {
          properties2.push(`${property}: ${value};`);
        }
      }
    ...
    setProperty(property, value, priority = null) {
      ...
      if (!allProperties2.has(property) && !allExtraProperties2.has(property)) {
        return;
      }
      this[property] = value;
      if (priority) {
  ...
  Object.defineProperties(CSSStyleDeclaration$1.prototype, {
    _shorthandGetter: {
      /**
       * @param {string} property
  ...
  Object.defineProperties(CSSStyleDeclaration$1.prototype, generatedProperties);
  [...allProperties2, ...allExtraProperties2].forEach(function(property) {
    if (!implementedProperties2.has(property)) {
      const declaration = getPropertyDescriptor(property);
      Object.defineProperty(CSSStyleDeclaration$1.prototype, property, declaration);
      const camel = dashedToCamelCase(property);
      Object.defineProperty(CSSStyleDeclaration$1.prototype, camel, declaration);
      if (/^webkit[A-Z]/.test(camel)) {
        const pascal = camel.replace(/^webkit/, "Webkit");
        Object.defineProperty(CSSStyleDeclaration$1.prototype, pascal, declaration);
      }
    }
  });
  CSSStyleDeclaration.CSSStyleDeclaration = CSSStyleDeclaration$1;
  return CSSStyleDeclaration;
}
export {
  requireCSSStyleDeclaration as r
};
