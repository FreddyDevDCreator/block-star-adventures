import { r as requireDist } from "./csstools__css-calc.mjs";
import { r as requireDist$1 } from "./csstools__css-tokenizer.mjs";
import { r as requireCommonjs } from "./lru-cache.mjs";
import { r as requireDist$2 } from "./csstools__css-color-parser.mjs";
import { r as requireDist$3 } from "./@csstools/css-parser-algorithms+[...].mjs";
var cjs;
var hasRequiredCjs;
function requireCjs() {
  ...
  var import_css_calc4 = requireDist();
  var import_css_tokenizer4 = requireDist$1();
  var import_lru_cache2 = /* @__PURE__ */ requireCommonjs();
  var import_css_tokenizer3 = requireDist$1();
  ...
  var import_css_tokenizer = requireDist$1();
  var {
  ...
  var import_css_color_parser = requireDist$2();
  var import_css_parser_algorithms2 = requireDist$3();
  var import_css_tokenizer2 = requireDist$1();
  var {
  ...
  function resolveRelativeColor(value, opt = {}) {
    ...
    const components = (0, import_css_parser_algorithms2.parseComponentValue)(tokens);
  ...
  var lruCache = new import_lru_cache2.LRUCache({
    max: MAX_CACHE
  });
