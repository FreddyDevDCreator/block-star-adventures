...
import { c as Route$1, g as getPrimaryChallenge, i as isGridChallenge, d as isQuizChallenge } from "./router-Cw9O-Iid.mjs";
import { B as BigButton } from "./BigButton-DM8Mi3tt.mjs";
import { p as playSfx, S as SoundToggle, M as Mascot, c as cn, u as useSettingsStore, s as speak } from "./SoundToggle-1U5H3jKo.mjs";
...
import { H as House, L as Lightbulb, e as RotateCcw, P as Play, a as Coins, b as Sparkles, T as Trophy } from "../_libs/lucide-react.mjs";
...
function directionalFeedback(finalPos, goalPos) {
  ...
  return lines.length ? lines.join(" ") : "Hmm! Keep changing the blocks — you will find the right answer, I know it!";
}
function PlayPage() {
  ...
  const onAnimationEnd = reactExports.useCallback(() => {
    ...
    if (win) {
      ...
      setFeedback({
        kind: "ok",
        msg: "Eiii, you did it! I knew you could fly me to the Moon!"
      });
      setReward(true);
    } else {
      playSfx("error");
  ...
  const onSubmitQuiz = () => {
    ...
    if (success) {
      ...
      setFeedback({
        kind: "ok",
        msg: "Eiii! Correct! You are learning fast!"
      });
      setReward(true);
    } else {
      setFeedback({
        kind: "err",
        msg: "Not yet — try again, you can do it!"
      });
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-[image:var(--gradient-sky)] flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-3", children: [
        isGrid && challenge.goalPos ? /* @__PURE__ */ jsxRuntimeExports.jsx(GridSim, { size: gridSize, trail, goal: challenge.goalPos, animating, onAnimationEnd }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-card border-2 border-border p-5 shadow-[var(--shadow-soft)]", children: [
          ...
          challenge.quiz?.kind === "multipleChoice" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid gap-2", children: (challenge.quiz?.choices ?? []).map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            ...
            setQuizAnswer(c2.id);
          }, className: ["text-left rounded-2xl border-2 px-4 py-3 font-bold transition-colors", quizAnswer === c2.id ? "border-primary bg-primary/10" : "border-border bg-card"].join(" "), children: c2.label }, c2.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: quizAnswer, onChange: (e) => {
            if (!quizStartedAt) setQuizStartedAt(Date.now());
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SpeechBubble, { className: "flex-1 text-sm", arrow: "left", speak: !animating, children: feedbackText })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(RewardModal, { open: reward, coins: rewardData.coins, xp: rewardData.xp, badge: rewardData.badge, onClose: () => {
      setReward(false);
      navigate({
        to: "/dashboard"
      });
