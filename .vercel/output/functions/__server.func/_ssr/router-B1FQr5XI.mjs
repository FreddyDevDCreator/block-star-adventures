...
async function narrate(text, opts = {}) {
  {
    try {
      const { narrateRemote } = await import("./narration-C40IoDHf.mjs");
...
async function stopNarration() {
  {
    const { stopRemoteNarration } = await import("./narration-C40IoDHf.mjs");
    stopRemoteNarration();
    return;
  }
}
...
const appCss = "/assets/styles-RJpmWx4y.css";
...
const $$splitComponentImporter$6 = () => import("./rewards-BSX_nAkY.mjs");
...
const $$splitComponentImporter$5 = () => import("./onboarding-BVPjtIW9.mjs");
...
const $$splitComponentImporter$4 = () => import("./journey-LNDkIsuy.mjs");
...
const $$splitComponentImporter$3 = () => import("./dashboard-gvp6blgg.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-D_F9vsTq.mjs");
...
const $$splitComponentImporter$1 = () => import("./play._id-DzYOzeD3.mjs");
...
const $$splitComponentImporter = () => import("./lesson._id-Bvoadv9X.mjs");
...
export {
  ...
  Route$1 as d,
  isQuizChallenge as e,
  fetchLessons as f,
  getPrimaryChallenge as g,
  getNextLevel as h,
  isGridChallenge as i,
  defaultProfile as j,
  persistProfilePatch as k,
  loadProfile as l,
  Route as m,
  narrate as n,
  playSfx as p,
