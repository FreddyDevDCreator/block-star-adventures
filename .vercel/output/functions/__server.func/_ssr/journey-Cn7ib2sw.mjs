...
import { R as Route$4 } from "./router-Cw9O-Iid.mjs";
...
function JourneyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-dvh bg-[image:var(--gradient-sky)] p-4 sm:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto flex flex-col gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: levels.map((lvl, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/play/$id", params: {
      id: lvl.lessonId
    }, search: {
      c: lvl.challengeId
