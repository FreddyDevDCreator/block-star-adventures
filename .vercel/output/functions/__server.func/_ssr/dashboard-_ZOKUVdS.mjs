...
import { S as SoundToggle, M as Mascot, c as cn } from "./SoundToggle-1U5H3jKo.mjs";
import { B as BigButton } from "./BigButton-DM8Mi3tt.mjs";
import { S as SyncStatus } from "./SyncStatus-DJWlUrNM.mjs";
import { u as useProgressStore, x as xpForNextLevel, a as xpProgress } from "./useProgressStore-X9ivf4wL.mjs";
import { u as useUserStore } from "./useUserStore-C_YsGkkw.mjs";
import { b as Route$3, g as getPrimaryChallenge } from "./router-Cw9O-Iid.mjs";
import "../_libs/idb.mjs";
import { a as Coins, b as Sparkles, T as Trophy, c as Star, d as Timer, R as Rocket, B as BookOpen, P as Play } from "../_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-dvh bg-[image:var(--gradient-sky)] p-4 sm:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto flex flex-col gap-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-3xl bg-card border-2 border-border p-5 shadow-[var(--shadow-soft)]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground", children: lesson?.title ?? "No lessons yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: lesson?.summary ?? "" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-xs text-muted-foreground", children: lesson ? `${completedScenes.filter((k) => k.startsWith(lesson.id)).length}/${primary?.scenes?.length ?? 0} scenes` : "" }),
      lesson && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/lesson/$id", params: {
        id: lesson.id
      }, className: "block mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BigButton, { className: "w-full", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-5 h-5" }), children: "Continue Learning" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-extrabold mb-2", children: "All Lessons" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/rewards", className: "self-center text-sm font-bold text-primary underline-offset-4 hover:underline", children: "View my badges →" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/journey", className: "self-center text-sm font-bold text-primary underline-offset-4 hover:underline", children: "Open my journey map →" }),
