...
import { u as unlockAudio, p as playSfx, a as apiFetch } from "./router-B1FQr5XI.mjs";
import { I as Input } from "./input-D6dSch3s.mjs";
import "../_libs/idb.mjs";
import { d as SkipForward, C as ChevronRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { className: "items-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 w-full flex flex-col items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md flex flex-col items-center gap-6 text-center", children: [
      ...
      isNameStep ? /* @__PURE__ */ jsxRuntimeExports.jsxs(SpeechBubble, { arrow: "bottom", className: "w-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: (current?.message ?? "").replaceAll("{name}", nameTrimmed || "Explorer").replaceAll("{hero}", nameTrimmed || "Explorer") })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigButton, { variant: "ghost", className: "flex-1", onClick: () => {
          void unlockAudio();
          playSfx("click");
          void finish();
        }, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SkipForward, { className: "w-5 h-5" }), children: "Skip" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BigButton, { className: "flex-[2]", onClick: isNameStep ? () => {
          ...
          playSfx("click");
          next();
        }, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-5 h-5" }), disabled: isNameStep && !nameIsValid || isAvatarStep && !avatarIsValid || isAgeStep && !ageIsValid, children: isNameStep ? "Continue" : step === totalSteps - 1 ? "Let's go!" : "Next" })
      ] })
    ] }) })
  ] });
}
